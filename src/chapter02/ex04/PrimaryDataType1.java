	...
	public static void main(String[] args) {
		...
		System.out.println(value6);
			...
			// long : 8byte = 64bit : 2^63 ~ 2^63-1
				// long 의 변수에 값을 할당 할 때에는 리터럴 뒤에 l, L 을 붙여줘야한다.
					// l, L 을 붙여주지 않으면 기본적으로 int 형으로 값이 저정됨
		long value7 = -100L;
		...
		// 3. 실수 ( float : 정밀도 7자리( 4byte ), double : 정밀도 15자리( 8byte )
			...
			//float : float 으로 지정된 변수의 값을 할당할 때 리터럴 끝에 f, F 명시
		float value8 = 1.123456789F;
		System.out.println(value8);		// 1.1234568 마지막은 올림
		
		double value9 = 1.12345678910111213;	// 1.1234567891011122 마지막은 올림
		...
		/*
		 < 문제 > 유니코드 구글로 검색해서 자신의 이름의 유니코드를 찾아서 변수에 할당
