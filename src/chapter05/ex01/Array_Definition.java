...
public class Array_Definition {
	...
	public static void main(String[] args) {
		...
		// 변수를 선언후 초기값을 할당 하지 않고 사용하면 오류 발생
		int c;
		int d;
		// int sum = c + d; // c, d 변수에 초기값을 넣지 않고 사용했으므로 오류.
		
		System.out.println("======배열 : 1. 선언방법 1 =====================");
		
		// 1. 배열 선언 case1
		int[] array1 = new int [3];		// 배열을 선언과 동시에 방의 갯수를 지정
		// int[] : 정수 값만 배열에 저장 가능
		// array1 : 배열 변수, array1 변수명은 Stack 공간에 저장이되고 array1 에 Heap 영역의 주소 값이 저장
		// new : Heap 영역에 값을 저장하라.
		// int[3] : Heap 영억에 저장할 방의 갯수를 지정
		//			index : 방의 번호 : 0, 1, 2, . . . . (0번 부터 들어감)
		
			// 배열에 값 할당. 
			array1[0] = 55;		// array1 의 Heap 영역의 주소 0 번째 방에 55를 넣어라.
			array1[1] = 66;		// array1 의 Heap 영역의 주소 1 번째 방에 66를 넣어라.
			array1[2] = 77;		// array1 의 Heap 영역의 주소 2 번째 방에 77를 넣어라.
			// 배열의 값 출력
		...
		int[] array2;			// 배열변수 선언
		array2=new int[5];		// 배열변수의 들어갈 방의 갯수 지정, index : 0, 1, 2, 3, 4
		...
		array2[4] = 55;
			...
			System.out.println("1 번째 방의 값 : "+ array2[1]);
			System.out.println("2 번째 방의 값 : "+ array2[2]);
			System.out.println("3 번째 방의 값 : "+ array2[3]);
			System.out.println("4 번째 방의 값 : "+ array2[4]);
		...
		// System.out.println(array3[4]);	// 오류 : 실행시 오류 예외 처리
		...
		// int [] array6 = new int[5] {10,20,30,40,50};
			// 오류 발생 : 선언과 동시에 배열 변수에 값을 할당 할때 방 갯수를 지정하면 오류
		array5[3]=77;
		...
		// System.out.println(array7[6]);	// 오류발생
			// ArrayIndexOutOfBoundsException : 배열의 방 크기를 넘어가면 발생되는 오류
		
		System.out.println("======배열 : 1. 선언방법 4 =====================");
		
		// 배열 선언가 동시에 값 할당 : 선언과 값 할당 분리시 오류 발생
