...
public class RectangleArrayDfintion {

	public static void main(String[] args) {
		// 다차원 배열 (2차원 배열)
		//	- 정방형 배열		: row(행) 에 대해서 열(colum, field) 이 동일한 배열 
		//	- 비정방형 배열		: row(행) 에 대해서 열(colum, field) 이 동일 하지 않는 배열
		
		// 1. 정방향 배열 선언 방법 case 1
		int [][] arr1 = new int [3][4];		// 3 : 행의 갯수 (0, 1, 2) 
			...
			// 4. 정방향 배열 선언과 동시에 값 넣기 : <주의> 방크기를 지정하면 오류 발생
			System.out.println("===============================================");
			...
			// 5. 정방향 배열 선언과 동시에 값넣기 2		: 선언, 값을 분리 할 수 없다.
