...
public class ArrayListMethod {
	...
	public static void main(String[] args) {
		...
		// 1. add(E element) : List 에 값을 추가 할때 : ArrayList, Vector, LinkedList 
			// 마지막 방에 값이 들어감.
		aList1.add(3);
		aList1.add(4);
		aList1.add(5);
		...
		aList1.add(1, 6); 	// 방번호 1 에 6 값을 넣겠다.
		...
		// 0 : 변환 할 배열방의 갯수인데, 컬렉션의 배열 방보다 작게 설정 된 경우 컬랙션의 맞추어서 처리
