...
class Aa implements A{
	@Override
	public void abc() {
		System.out.println("객체 생성 후 메소드 완성");
	}
}

// 2. 익명 클래스를 사용해서 출력, 자식 클래스를 생성하지 않고
interface B {
	void bcd();
}
...
public class Interface_Test {
	...
	public static void main(String[] args) {
		...
		B b1 = new B() {		// B 는 인터페이스 이기 때문에 객체를 생성 할 수 없다. 익명 클래스로 출력
			@Override
			public void bcd() {
				System.out.println("B 인터페이스의 구현된 메소드 bcd(), (익명 클래스로 출력)");	
			}	
		};
		b1.bcd();
