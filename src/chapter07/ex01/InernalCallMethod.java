...
public class InernalCallMethod {
	...
	// main : 메소드 <== static 이 붙어 있는 메소두
	public static void main(String[] args) {
		// 클래스 내부에서 다른 메소드 호출 
			// main 메소드는 메소드 이름 앞에 public : 다른 패키지에서 호출 가능
			// static : 인스턴스화 하지 않고 사용 가능하다. 객체를 생성하지 않고 사용 가능
		...
		// sum2 는 바로 호출시 오류 발생 <== 객체화 해서 호출해야 한다
	//	double dd = sum2(20, 33.3);		// 객체화 하지 않아서 오류 발생
		
		
		// sum2 메소드 호출 : 인스턴스 메소드 : 객체화를 해야 사용 가능 
