...
public class ArrayArgumentMethod {
	...
	// 매개변수로 배열을 인풋받는 메소드 : 배열의 각방의 모든 내용을 출력해 주는 메소드
		// 메소드 : 함수(프로개르맹의 기능)
	public static void printArray(int[] a) {
		// 1. 배열의 Index : 방번호 0 ~ 마지막 방번호 까지 for 문을 사용해서 출력
		...
		System.out.println("3. Arrays.toString() 을 사요해서 출력 ==============");
