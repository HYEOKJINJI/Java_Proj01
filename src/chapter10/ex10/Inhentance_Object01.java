...
// java.lang 패키지의 모든 클래스는 import 없이 사용가능.

class A{			//  extends Object 생략되어 있다. 
					// Object 클래스의 모든 메소드를 상속 받는다.
					// 자식 클래스는 하나의 부모만 상속 할 수 있다.
					// Java 는 다중 상속이 불가함.
					// 인터페이스는 다중 상속이(Implements) 가능
	int m = 3;
	int n = 4;
	...
	// toString() : Object 클래스의 메소드
		// 객체를 출력시 toString() 메소드가 작동이 되고, 기본적으로는 chapter10.ex10.A@4e718207
...
public class Inhentance_Object01 {
