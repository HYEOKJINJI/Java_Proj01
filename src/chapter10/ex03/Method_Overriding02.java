...
class Animal{
	...
	void animalsound() {
		System.out.println("모든 동물은 소리를 내어 웁니다.");
	}
}
...
public class Method_Overriding02 {
	...
	public static void main(String[] args) {
		...
		// 메소드 오버라이딩, 오버라이딩 메소드 출력.....
		// Animal 의 메소드 호출시 오버라이딩 된 자식의 메소드가 출력
		t1.animalsound();	// Animal 의 animalsound 호출 시, Tiger 의 animalsound 가 출력
		t2.animalsound();	// Animal 의 animalsound 호출 시, Lion 의 animalsound 가 출력
		t3.animalsound();	// Animal 의 animalsound 호출 시, Eagle 의 animalsound 가 출력
