...
public class Package {
	...
	public static void main(String[] args) {
		...
		// 클래스 외부 구성요소 
			...
			// 2. 임포트(import) : 다른 패키지의 클래스를 사용 하려고 하는 경우 : import
		// Student 클래스의 객체 생성 : 다른 패키지에 존재하는 클래스
			// chpter08.ex02.Student 
		
		// 기본 생성자 호출
		// Student : import 클래스 외부.
		Student s1 = new Student();
		s1.print();
		System.out.println();
		
		// 매개변수 4개인 생성자 호출
		Student s2 = new Student("홍길동", "1111", 3, "서울 종로구 하이미디어");
		s2.print();
		
		System.out.println("=========================================");
		
		// Car 클래스는 import 없이 전체 이름(패키지이름.클래스이름) 으로 사용
