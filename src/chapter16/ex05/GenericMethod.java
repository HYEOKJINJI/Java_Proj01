...
class GenericMethods {
	...
	// 동일한 타입의 두 값을 인풋 받아서 같으면 true, 다르면 false 로 리턴
	// 제너릭에 넣는 타입 변수 T 에 올 수 있는것은 기본 타입은 넣을 수 없다.
	// wrapper 클래스만 올 수 있다.
...
public class GenericMethod {
	...
	public static void main(String[] args) {
		...
		String str2 = gm.method1("하세요");	 // 뒤의 인풋값으로 타입을 유추 할 수 있는 경우 생략가능
		...
		System.out.println("============================");
		gm.<String, String>method3("아바타2", "롯데시네마");
